...
std::shared_ptr<CActor> CSpartyFactory::Create()
{
    ...
    torso->AddChild(rarm);
	auto knife = make_shared<CKnife>(L"Knife", L"images/knife.png");
	knife->SetCenter(Point(0, 40));
	knife->SetPosition(Point(-65, 105));
	rarm->AddChild(knife);
	...
	///////////////////////////////////////////////
	auto textbubble = make_shared<CTextBubbleDrawable>(L"textbubble");
	textbubble->SetPosition(Point(45, -200));
	//textbubble->SetText(L"2");
